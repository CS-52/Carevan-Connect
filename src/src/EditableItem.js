    ...
    return (
      <li className="item">
        <div className="row vertical-center">
          <div className="one-third column" style={{textDecoration: decoration}}>
            {this.props.name}
          </div> 
          <div className="two-thirds column">
            ...
            <button className="portalButton" onClick={e => this.flipOutOfStock(this.props.id)} style={{ float: "left" }}> 
